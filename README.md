...
Данный telegram-бот предназначен для поддержания системы белого списка в чате. Если есть какой-то пользователь, который не состоит в списке, то его нужно кикать из чата.  

**Что увидит пользователь:**
- Личку с ботом, в которой можно почитать о назначении и использовании бота
- После добавлении в групповой чат пользователи этого чата смогут взаимодействовать с ботом и белым списком через команды, описанные ниже:
...
- Aiogram - реализация Telegram-бота
- Telethon - расширенное взаимодействие с Telegram API
- SQLAlchemy - работа с базой данных
- Docker - контейнеризация приложения
- Pytest - тестирование
## Запуск приложения
Для привязки к боту и базе данных в корне репозитория нужно создать папку ```secrets``` и поместить в неё:
