...
import bot.bot_launch as bot_launch   # noqa: E402
...
async def test_activate() -> None:
    ...
    with patch.object(bot_launch, 'Bot', return_value=mock_bot), \
         patch.object(bot_launch, 'TelethonHelper',
                      return_value=mock_telethon_helper), \
         ...
         patch('builtins.open',
               mock_open(read_data="test_bot_token\n123\ntest_api_hash\n")), \
