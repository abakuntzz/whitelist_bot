...
@pytest.mark.asyncio
async def test_add_user_to_whitelist(mock_db_session):
    mock_result1 = Mock()
...
@pytest.mark.asyncio
async def test_remove_user_from_whitelist(mock_db_session):
    mock_result = Mock()
...
@pytest.mark.asyncio
async def test_get_chat_status(mock_db_session):
    mock_result = Mock()
    mock_chat = Mock()
...
@pytest.mark.asyncio
async def test_update_pause_status(mock_db_session):
    mock_result = Mock()
    mock_chat = Mock()
...
@pytest.mark.asyncio
async def test_get_whitelist_by_chat(mock_db_session):
    mock_result = Mock()
...
@pytest.mark.asyncio
async def test_is_user_in_whitelist(mock_db_session):
    mock_result = Mock()
